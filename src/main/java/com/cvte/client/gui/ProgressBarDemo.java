    ...
    public void start(Stage stage) throws Exception {
        ...
        Timeline timeline = new Timeline(
            new KeyFrame(
                ...
                new KeyValue(jfxBar.secondaryProgressProperty(), 0),
                new KeyValue(jfxBar1.progressProperty(), 0)),
            new KeyFrame(
                Duration.seconds(1),
                new KeyValue(jfxBar.secondaryProgressProperty(), 1),
                new KeyValue(jfxBar1.secondaryProgressProperty(), 1)),
            new KeyFrame(
                Duration.seconds(2),
                new KeyValue(bar.progressProperty(), 1),
                new KeyValue(jfxBar.progressProperty(), 1),
                new KeyValue(jfxBar1.progressProperty(), 1)));

        timeline.setCycleCount(Timeline.INDEFINITE);
        timeline.play();

        pane.getChildren().addAll(bar, jfxBar, cssBar, jfxBarInf, jfxBar1);
        ...
        scene.getStylesheets().add(ProgressBarDemo.class.getResource("jfoenix-components.css").toExternalForm());
