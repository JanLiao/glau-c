...
public class JFXScrollPaneMark extends StackPane {
    ...
    public JFXScrollPaneMark() {
        ...
        condensedHeaderBackground.setBackground(new Background(new BackgroundFill(Color.valueOf("#1E88E5"),
                                                                                  CornerRadii.EMPTY,
                                                                                  Insets.EMPTY)));
        headerBackground.setBackground(new Background(new BackgroundFill(Color.valueOf("#7E57C2"),
                                                                         CornerRadii.EMPTY,
                                                                         Insets.EMPTY)));
